...
<header>
    ...
    <a href="#" class="logo"><span>THE VOYAGE</span></a>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <p>Booking my dream trip to the serene backwaters of Kerala was a breeze with THE VOYAGEs – seamless and stress-free! </p>
        <div class="user">
            <img src="./images/AJ.jpg" alt="anubhav pfp">
            <div class="user-info">
                <h3>Anubhav</h3>
                <span>Goa</span>
            </div>
    ...
    <div class="box">
        ...
        <p>Thanks to THE VOYAGEs, I explored the majestic beauty of Rajasthan with ease, and the deals were unbeatable!</p>
        <div class="user">
            <img src="./images/harshit.jpg" alt="harshit pfp">
            <div class="user-info">
                <h3>Harshit</h3>
    ...
    <div class="box">
        ...
        <div class="user">
            <img src="./images/karan.jpg" alt="Karan pfp">
            <div class="user-info">
                <h3>Karan </h3>
                <span>Kerala</span>
            </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
        <h3>Contact Info</h3>
        <p>Email: <a href="mailto:thevoyage.travel@gmail.com">thevoyage.travel@gmail.com</a></p>
    ...
    <div class="credit">&copy;2024 THE VOYAGE. All Rights Reserved. | <a href="privacy-policy.html">Privacy Policy</a></p>
</div>
